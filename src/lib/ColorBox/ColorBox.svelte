<script lang="ts">
	...
	import contast, { isAccessible, score } from 'get-contrast'	// https://www.w3.org/TR/WCAG20/#visual-audio-contrast
...
<div class="contrast">
	...
	<div class="color-boxes">
		<div class="color-box">
			<div class="color-box-preview" style="background-color: {layer1};">
			</div>
			<input class="color-box-input" bind:value={layer1} readonly on:paste={refreshLayer1}>
		</div>

		<div class="color-box">
			<div class="color-box-preview" style="background-color: {layer2};">	
			</div>
		...
		<div class="color-box">
			<div class="color-box-preview" style="background-color: {layer3};">	
			</div>
